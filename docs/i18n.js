...
en: {
  _name: 'English',
  'nav.registry': 'Registry', 'nav.github': 'GitHub',
  ...
  'why.p': 'The dsh-plugin ecosystem grew from ~200 to 6,900+ repositories in 30 days. A plugin is arbitrary code inside your agent runtime — and today nothing surfaces its real capability surface before you install it.',
...
zh: {
  _name: '简体中文',
  'nav.registry': '插件注册表', 'nav.github': 'GitHub',
  ...
  'why.p': 'dsh-plugin 生态 30 天内从约 200 个仓库涨到 6,900+。插件就是跑在你 Agent 运行时里的任意代码——而今天,安装前没有任何东西告诉你它真实的能力面。',
  'card1.t': '改写你的系统提示词',
...
ja: {
  _name: '日本語',
  'nav.registry': 'レジストリ', 'nav.github': 'GitHub',
  ...
  'why.p': 'dsh-plugin エコシステムは 30 日間で約 200 から 6,900+ リポジトリに急増。プラグインはランタイム内で動く任意のコードだが、インストール前にその実際の能力面を示すものは今のところ存在しない。',
