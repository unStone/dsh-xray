...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10080 | 83% |
| Declares only dsh.client — not installable | 634 | 5% |
| No dsh integration found | 490 | 4% |
| A skill, not an installable plugin | 384 | 3% |
| Depends on dsh packages, no plugin manifest | 384 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3958 | 33% |
| **C2** | Powerful (one of) | 7120 | 58% |
| **C1** | Ordinary | 669 | 5% |
| **C0** | No notable surface | 424 | 3% |
...
<!--STATS_PATCH-->
**9983 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,907★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 28,755★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,882★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,073★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,937★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1222 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-29 · 12171 of 12468 repositories scanned · Top flags: `runtime_patch` 9983, `exec` 3662, `prompt_surface` 1368, `token_env` 1222, `base64_decode` 986, `net_server` 847*
