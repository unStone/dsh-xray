...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12211 | 84% |
| Declares only dsh.client — not installable | 659 | 5% |
| No dsh integration found | 544 | 4% |
| Depends on dsh packages, no plugin manifest | 440 | 3% |
| A skill, not an installable plugin | 422 | 3% |
| Plugin code with no manifest to install it by | 202 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4376 | 30% |
| **C2** | Powerful (one of) | 8900 | 61% |
| **C1** | Ordinary | 743 | 5% |
| **C0** | No notable surface | 459 | 3% |
...
<!--STATS_PATCH-->
**12102 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,249★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 62,717★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 42,901★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 23,488★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,324★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1389 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-15 · 14478 of 14805 repositories scanned · Top flags: `runtime_patch` 12102, `exec` 3973, `prompt_surface` 1686, `token_env` 1389, `base64_decode` 1238, `net_server` 1032*
