...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11474 | 84% |
| Declares only dsh.client — not installable | 643 | 5% |
| No dsh integration found | 529 | 4% |
| Depends on dsh packages, no plugin manifest | 423 | 3% |
| A skill, not an installable plugin | 415 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4050 | 30% |
| **C2** | Powerful (one of) | 8460 | 62% |
| **C1** | Ordinary | 726 | 5% |
| **C0** | No notable surface | 451 | 3% |
...
<!--STATS_PATCH-->
**11367 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 95,007★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 55,206★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,358★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,893★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,238★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1301 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-09 · 13687 of 14000 repositories scanned · Top flags: `runtime_patch` 11367, `exec` 3700, `prompt_surface` 1592, `token_env` 1301, `base64_decode` 1123, `exec_bundled` 931*
