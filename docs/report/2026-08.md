...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12637 | 85% |
| Declares only dsh.client — not installable | 664 | 4% |
| No dsh integration found | 538 | 4% |
| Depends on dsh packages, no plugin manifest | 445 | 3% |
| A skill, not an installable plugin | 437 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4581 | 31% |
| **C2** | Powerful (one of) | 9137 | 61% |
| **C1** | Ordinary | 739 | 5% |
| **C0** | No notable surface | 470 | 3% |
...
<!--STATS_PATCH-->
**12519 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,984★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 66,981★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,177★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 27,116★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,460★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1440 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-19 · 14927 of 15263 repositories scanned · Top flags: `runtime_patch` 12519, `exec` 4155, `prompt_surface` 1751, `token_env` 1440, `base64_decode` 1299, `net_server` 1082*
