...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11072 | 84% |
| Declares only dsh.client — not installable | 636 | 5% |
| No dsh integration found | 517 | 4% |
| A skill, not an installable plugin | 412 | 3% |
| Depends on dsh packages, no plugin manifest | 401 | 3% |
| Plugin code with no manifest to install it by | 202 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3867 | 29% |
| **C2** | Powerful (one of) | 8218 | 62% |
| **C1** | Ordinary | 708 | 5% |
| **C0** | No notable surface | 447 | 3% |
...
<!--STATS_PATCH-->
**10970 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 94,135★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 48,462★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,196★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,373★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,191★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1267 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-05 · 13240 of 13549 repositories scanned · Top flags: `runtime_patch` 10970, `exec` 3521, `prompt_surface` 1513, `token_env` 1267, `base64_decode` 1065, `exec_bundled` 904*
