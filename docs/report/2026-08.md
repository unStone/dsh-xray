...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 8956 | 82% |
| Declares only dsh.client — not installable | 588 | 5% |
| No dsh integration found | 464 | 4% |
| A skill, not an installable plugin | 367 | 3% |
| Depends on dsh packages, no plugin manifest | 349 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3304 | 30% |
| **C2** | Powerful (one of) | 6574 | 60% |
| **C1** | Ordinary | 634 | 6% |
| **C0** | No notable surface | 390 | 4% |
...
<!--STATS_PATCH-->
**8870 plugins (81%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,668★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,548★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 15,432★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,955★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,767★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**923 plugins (8%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-25 · 10902 of 11178 repositories scanned · Top flags: `runtime_patch` 8870, `exec` 3224, `prompt_surface` 1199, `token_env` 923, `base64_decode` 867, `net_server` 740*
