...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 13388 | 85% |
| Declares only dsh.client — not installable | 667 | 4% |
| No dsh integration found | 548 | 3% |
| A skill, not an installable plugin | 455 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4882 | 31% |
| **C2** | Powerful (one of) | 9613 | 61% |
| **C1** | Ordinary | 729 | 5% |
| **C0** | No notable surface | 492 | 3% |
...
<!--STATS_PATCH-->
**13268 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 98,123★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 71,924★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,425★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 30,163★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 29,022★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1540 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-26 · 15716 of 16050 repositories scanned · Top flags: `runtime_patch` 13268, `exec` 4386, `prompt_surface` 1870, `token_env` 1540, `base64_decode` 1373, `net_server` 1181*
