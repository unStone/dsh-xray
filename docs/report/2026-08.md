...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 8583 | 91% |
| A skill, not an installable plugin | 262 | 3% |
| other | 217 | 2% |
| No dsh integration found | 148 | 2% |
| Declares only dsh.client — not installable | 105 | 1% |
| Depends on dsh packages, no plugin manifest | 57 | 1% |
| Plugin code with no manifest to install it by | 25 | 0% |

**9% of repositories carrying the `dsh-plugin` topic are not installable plugins.**
<!--/STATS_TYPES-->
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2779 | 30% |
| **C2** | Powerful (one of) | 5689 | 61% |
| **C1** | Ordinary | 586 | 6% |
| **C0** | No notable surface | 343 | 4% |
...
<!--STATS_PATCH-->
**7576 plugins (81%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,331★
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) — 31,099★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,745★
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) — 12,271★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,853★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**773 plugins (8%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-21 · 9397 of 9638 repositories scanned · Top flags: `runtime_patch` 7576, `exec` 2729, `prompt_surface` 1017, `token_env` 773, `base64_decode` 729, `net_server` 632*
