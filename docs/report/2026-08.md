...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2920 | 40% |
| **C2** | Powerful (one of) | 3548 | 49% |
| **C1** | Ordinary | 506 | 7% |
| **C0** | No notable surface | 291 | 4% |
...
<!--STATS_PATCH-->
**5566 plugins (77%) patch the dsh runtime itself via `manifest.bundle.patch`.**
...
<!--STATS_TOKEN-->
**681 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-19 · 7265 of 7534 repositories scanned · Top flags: `runtime_patch` 5566, `exec` 2902, `base64_decode` 933, `prompt_surface` 919, `token_env` 681, `net_server` 599*
