...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10559 | 83% |
| Declares only dsh.client — not installable | 639 | 5% |
| No dsh integration found | 498 | 4% |
| A skill, not an installable plugin | 397 | 3% |
| Depends on dsh packages, no plugin manifest | 388 | 3% |
| Plugin code with no manifest to install it by | 201 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3667 | 29% |
| **C2** | Powerful (one of) | 7874 | 62% |
| **C1** | Ordinary | 702 | 6% |
| **C0** | No notable surface | 439 | 3% |
...
<!--STATS_PATCH-->
**10458 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,027★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 40,050★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,090★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,129★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 7,006★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1192 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-01 · 12682 of 12987 repositories scanned · Top flags: `runtime_patch` 10458, `exec` 3347, `prompt_surface` 1428, `token_env` 1192, `base64_decode` 1005, `exec_bundled` 855*
