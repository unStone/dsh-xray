...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10945 | 84% |
| Declares only dsh.client — not installable | 640 | 5% |
| No dsh integration found | 510 | 4% |
| A skill, not an installable plugin | 409 | 3% |
| Depends on dsh packages, no plugin manifest | 395 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3818 | 29% |
| **C2** | Powerful (one of) | 8134 | 62% |
| **C1** | Ordinary | 704 | 5% |
| **C0** | No notable surface | 444 | 3% |
...
<!--STATS_PATCH-->
**10844 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 93,939★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 46,548★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,167★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,302★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,178★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1246 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-04 · 13100 of 13411 repositories scanned · Top flags: `runtime_patch` 10844, `exec` 3477, `prompt_surface` 1494, `token_env` 1246, `base64_decode` 1051, `exec_bundled` 888*
