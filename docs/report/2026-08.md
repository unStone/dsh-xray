...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2403 | 33% |
| **C2** | Powerful (one of) | 4049 | 55% |
| **C1** | Ordinary | 557 | 8% |
| **C0** | No notable surface | 319 | 4% |

**88% of scanned plugins carry a powerful capability surface (C2+); 33% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**5618 plugins (77%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,050★
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) — 29,555★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,278★
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) — 12,156★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,772★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**677 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-19 · 7328 of 7597 repositories scanned · Top flags: `runtime_patch` 5618, `exec` 2394, `prompt_surface` 918, `token_env` 677, `base64_decode` 626, `net_server` 551*
