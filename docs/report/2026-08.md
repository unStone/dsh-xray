...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12091 | 84% |
| Declares only dsh.client — not installable | 656 | 5% |
| No dsh integration found | 538 | 4% |
| Depends on dsh packages, no plugin manifest | 436 | 3% |
| A skill, not an installable plugin | 425 | 3% |
| Plugin code with no manifest to install it by | 204 | 1% |

**16% of repositories carrying the `dsh-plugin` topic are not installable plugins.**
<!--/STATS_TYPES-->
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4316 | 30% |
| **C2** | Powerful (one of) | 8833 | 62% |
| **C1** | Ordinary | 740 | 5% |
| **C0** | No notable surface | 461 | 3% |

**92% of scanned plugins carry a powerful capability surface (C2+); 30% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**11981 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,032★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 61,340★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 42,793★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 23,003★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,309★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1374 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-14 · 14350 of 14679 repositories scanned · Top flags: `runtime_patch` 11981, `exec` 3925, `prompt_surface` 1675, `token_env` 1374, `base64_decode` 1219, `net_server` 1015*
