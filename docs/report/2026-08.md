...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 9409 | 82% |
| Declares only dsh.client — not installable | 601 | 5% |
| No dsh integration found | 473 | 4% |
| A skill, not an installable plugin | 382 | 3% |
| Depends on dsh packages, no plugin manifest | 356 | 3% |
| Plugin code with no manifest to install it by | 188 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3450 | 30% |
| **C2** | Powerful (one of) | 6911 | 61% |
| **C1** | Ordinary | 646 | 6% |
| **C0** | No notable surface | 402 | 4% |

**91% of scanned plugins carry a powerful capability surface (C2+); 30% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**9321 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,735★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,631★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 16,416★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,986★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,818★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**962 plugins (8%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-26 · 11409 of 11690 repositories scanned · Top flags: `runtime_patch` 9321, `exec` 3372, `prompt_surface` 1246, `token_env` 962, `base64_decode` 909, `net_server` 769*
