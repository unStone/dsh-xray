...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11528 | 84% |
| Declares only dsh.client — not installable | 645 | 5% |
| No dsh integration found | 526 | 4% |
| Depends on dsh packages, no plugin manifest | 420 | 3% |
| A skill, not an installable plugin | 416 | 3% |
| Plugin code with no manifest to install it by | 200 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4077 | 30% |
| **C2** | Powerful (one of) | 8486 | 62% |
| **C1** | Ordinary | 722 | 5% |
...
<!--STATS_PATCH-->
**11421 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 95,248★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 56,467★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,397★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,983★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,258★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1310 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-10 · 13735 of 14050 repositories scanned · Top flags: `runtime_patch` 11421, `exec` 3720, `prompt_surface` 1591, `token_env` 1310, `base64_decode` 1133, `exec_bundled` 936*
