...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11274 | 84% |
| Declares only dsh.client — not installable | 639 | 5% |
| No dsh integration found | 526 | 4% |
| A skill, not an installable plugin | 414 | 3% |
| Depends on dsh packages, no plugin manifest | 398 | 3% |
| Plugin code with no manifest to install it by | 205 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3965 | 29% |
| **C2** | Powerful (one of) | 8327 | 62% |
| **C1** | Ordinary | 714 | 5% |
| **C0** | No notable surface | 450 | 3% |
...
<!--STATS_PATCH-->
**11168 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 94,533★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 51,393★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,269★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,625★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,210★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1288 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-07 · 13456 of 13778 repositories scanned · Top flags: `runtime_patch` 11168, `exec` 3606, `prompt_surface` 1554, `token_env` 1288, `base64_decode` 1100, `exec_bundled` 917*
