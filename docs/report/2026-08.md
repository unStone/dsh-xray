...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11370 | 84% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4005 | 29% |
| **C2** | Powerful (one of) | 8400 | 62% |
| **C1** | Ordinary | 724 | 5% |
| **C0** | No notable surface | 454 | 3% |
...
<!--STATS_PATCH-->
**11262 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 94,772★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 53,605★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,305★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,757★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,225★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1294 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-08 · 13583 of 13889 repositories scanned · Top flags: `runtime_patch` 11262, `exec` 3661, `prompt_surface` 1575, `token_env` 1294, `base64_decode` 1112, `exec_bundled` 922*
