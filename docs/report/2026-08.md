...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10678 | 83% |
| Declares only dsh.client — not installable | 638 | 5% |
| No dsh integration found | 492 | 4% |
| A skill, not an installable plugin | 401 | 3% |
| Depends on dsh packages, no plugin manifest | 389 | 3% |
| Plugin code with no manifest to install it by | 199 | 2% |

**17% of repositories carrying the `dsh-plugin` topic are not installable plugins.**
<!--/STATS_TYPES-->
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3708 | 29% |
| **C2** | Powerful (one of) | 7948 | 62% |
| **C1** | Ordinary | 703 | 5% |
| **C0** | No notable surface | 438 | 3% |

**91% of scanned plugins carry a powerful capability surface (C2+); 29% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**10575 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 42,564★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,076★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,151★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,149★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 7,024★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1208 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-02 · 12797 of 13104 repositories scanned · Top flags: `runtime_patch` 10575, `exec` 3377, `prompt_surface` 1451, `token_env` 1208, `base64_decode` 1010, `exec_bundled` 863*
