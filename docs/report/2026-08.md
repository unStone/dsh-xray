...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12424 | 85% |
| Declares only dsh.client — not installable | 658 | 4% |
| No dsh integration found | 538 | 4% |
| Depends on dsh packages, no plugin manifest | 443 | 3% |
| A skill, not an installable plugin | 428 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4484 | 31% |
| **C2** | Powerful (one of) | 9010 | 61% |
| **C1** | Ordinary | 737 | 5% |
...
<!--STATS_PATCH-->
**12312 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,633★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 65,242★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,066★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 25,710★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,491★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1419 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-17 · 14696 of 15027 repositories scanned · Top flags: `runtime_patch` 12312, `exec` 4068, `prompt_surface` 1714, `token_env` 1419, `base64_decode` 1267, `net_server` 1057*
