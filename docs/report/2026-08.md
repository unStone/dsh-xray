...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11684 | 84% |
| Declares only dsh.client — not installable | 646 | 5% |
| No dsh integration found | 533 | 4% |
| Depends on dsh packages, no plugin manifest | 427 | 3% |
| A skill, not an installable plugin | 415 | 3% |
| Plugin code with no manifest to install it by | 199 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4128 | 30% |
| **C2** | Powerful (one of) | 8597 | 62% |
| **C1** | Ordinary | 726 | 5% |
| **C0** | No notable surface | 453 | 3% |
...
<!--STATS_PATCH-->
**11577 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 95,492★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 57,775★
- [reactive-resume/app](https://github.com/reactive-resume/app) — 42,451★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 22,200★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,282★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1320 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-11 · 13904 of 14223 repositories scanned · Top flags: `runtime_patch` 11577, `exec` 3765, `prompt_surface` 1613, `token_env` 1320, `base64_decode` 1151, `exec_bundled` 952*
