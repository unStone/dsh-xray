...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 7989 | 82% |
| Declares only dsh.client — not installable | 533 | 5% |
| No dsh integration found | 431 | 4% |
| A skill, not an installable plugin | 339 | 3% |
| Depends on dsh packages, no plugin manifest | 318 | 3% |
| Plugin code with no manifest to install it by | 159 | 2% |
| other | 5 | 0% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2939 | 30% |
| **C2** | Powerful (one of) | 5879 | 60% |
| **C1** | Ordinary | 599 | 6% |
| **C0** | No notable surface | 357 | 4% |
...
<!--STATS_PATCH-->
**7873 plugins (81%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,592★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,450★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 15,173★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,940★
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) — 5,774★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**829 plugins (8%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-24 · 9774 of 10029 repositories scanned · Top flags: `runtime_patch` 7873, `exec` 2901, `prompt_surface` 1085, `token_env` 829, `base64_decode` 778, `net_server` 687*
