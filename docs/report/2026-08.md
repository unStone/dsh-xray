...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12870 | 85% |
| Declares only dsh.client — not installable | 657 | 4% |
| No dsh integration found | 542 | 4% |
| Depends on dsh packages, no plugin manifest | 451 | 3% |
| A skill, not an installable plugin | 445 | 3% |
| Plugin code with no manifest to install it by | 204 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4675 | 31% |
| **C2** | Powerful (one of) | 9290 | 61% |
| **C1** | Ordinary | 732 | 5% |
| **C0** | No notable surface | 472 | 3% |
...
<!--STATS_PATCH-->
**12752 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 68,581★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,244★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 28,243★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 28,164★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,499★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1471 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-21 · 15169 of 15509 repositories scanned · Top flags: `runtime_patch` 12752, `exec` 4232, `prompt_surface` 1785, `token_env` 1471, `base64_decode` 1328, `net_server` 1118*
