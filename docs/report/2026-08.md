...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 13192 | 85% |
| Declares only dsh.client — not installable | 665 | 4% |
| No dsh integration found | 550 | 4% |
| Depends on dsh packages, no plugin manifest | 452 | 3% |
| A skill, not an installable plugin | 448 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4783 | 31% |
| **C2** | Powerful (one of) | 9519 | 61% |
| **C1** | Ordinary | 728 | 5% |
| **C0** | No notable surface | 484 | 3% |
...
<!--STATS_PATCH-->
**13072 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 97,870★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 70,826★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,381★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 29,496★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 28,777★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1515 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-24 · 15514 of 15851 repositories scanned · Top flags: `runtime_patch` 13072, `exec` 4318, `prompt_surface` 1845, `token_env` 1515, `base64_decode` 1359, `net_server` 1159*
