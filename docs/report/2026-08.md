...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12757 | 85% |
| Declares only dsh.client — not installable | 657 | 4% |
| No dsh integration found | 539 | 4% |
| Depends on dsh packages, no plugin manifest | 447 | 3% |
| A skill, not an installable plugin | 442 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4630 | 31% |
| **C2** | Powerful (one of) | 9213 | 61% |
| **C1** | Ordinary | 732 | 5% |
...
<!--STATS_PATCH-->
**12638 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 97,161★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 67,736★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,204★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 27,683★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,475★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1452 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-20 · 15047 of 15384 repositories scanned · Top flags: `runtime_patch` 12638, `exec` 4193, `prompt_surface` 1769, `token_env` 1452, `base64_decode` 1315, `net_server` 1100*
