...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12554 | 85% |
| Declares only dsh.client — not installable | 658 | 4% |
| No dsh integration found | 536 | 4% |
| Depends on dsh packages, no plugin manifest | 444 | 3% |
| A skill, not an installable plugin | 431 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4545 | 31% |
| **C2** | Powerful (one of) | 9084 | 61% |
| **C1** | Ordinary | 736 | 5% |
| **C0** | No notable surface | 465 | 3% |
...
<!--STATS_PATCH-->
**12438 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,825★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 66,183★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,119★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 26,589★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,436★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1431 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-18 · 14830 of 15168 repositories scanned · Top flags: `runtime_patch` 12438, `exec` 4123, `prompt_surface` 1735, `token_env` 1431, `base64_decode` 1288, `net_server` 1071*
