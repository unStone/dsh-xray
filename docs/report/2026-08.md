...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 9542 | 82% |
| Declares only dsh.client — not installable | 627 | 5% |
| No dsh integration found | 484 | 4% |
| A skill, not an installable plugin | 379 | 3% |
| Depends on dsh packages, no plugin manifest | 367 | 3% |
| Plugin code with no manifest to install it by | 197 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3614 | 31% |
| **C2** | Powerful (one of) | 6900 | 60% |
| **C1** | Ordinary | 666 | 6% |
| **C0** | No notable surface | 416 | 4% |

**91% of scanned plugins carry a powerful capability surface (C2+); 31% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**9448 plugins (81%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,825★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 21,135★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,758★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,035★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,883★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1000 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-27 · 11596 of 11887 repositories scanned · Top flags: `runtime_patch` 9448, `exec` 3503, `prompt_surface` 1307, `token_env` 1000, `base64_decode` 949, `net_server` 804*
