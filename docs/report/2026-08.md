...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10845 | 83% |
| Declares only dsh.client — not installable | 643 | 5% |
| No dsh integration found | 507 | 4% |
| A skill, not an installable plugin | 405 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3768 | 29% |
| **C2** | Powerful (one of) | 8076 | 62% |
| **C1** | Ordinary | 709 | 5% |
| **C0** | No notable surface | 445 | 3% |
...
<!--STATS_PATCH-->
**10741 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 93,709★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 44,453★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,120★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,233★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,164★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1223 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-03 · 12998 of 13309 repositories scanned · Top flags: `runtime_patch` 10741, `exec` 3441, `prompt_surface` 1473, `token_env` 1223, `base64_decode` 1035, `exec_bundled` 880*
