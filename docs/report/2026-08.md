...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10266 | 83% |
| Declares only dsh.client — not installable | 633 | 5% |
| No dsh integration found | 489 | 4% |
| A skill, not an installable plugin | 392 | 3% |
| Depends on dsh packages, no plugin manifest | 380 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3584 | 29% |
| **C2** | Powerful (one of) | 7653 | 62% |
| **C1** | Ordinary | 687 | 6% |
| **C0** | No notable surface | 437 | 4% |
...
<!--STATS_PATCH-->
**10166 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,987★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 36,252★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,026★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,105★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,984★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1163 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-31 · 12361 of 12669 repositories scanned · Top flags: `runtime_patch` 10166, `exec` 3279, `prompt_surface` 1384, `token_env` 1163, `base64_decode` 968, `exec_bundled` 832*
