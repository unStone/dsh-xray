...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2584 | 31% |
| **C2** | Powerful (one of) | 4956 | 59% |
| **C1** | Ordinary | 577 | 7% |
| **C0** | No notable surface | 326 | 4% |

**89% of scanned plugins carry a powerful capability surface (C2+); 31% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**6685 plugins (79%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,188★
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) — 30,327★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,519★
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) — 12,217★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,814★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**726 plugins (9%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-20 · 8443 of 8676 repositories scanned · Top flags: `runtime_patch` 6685, `exec` 2557, `prompt_surface` 971, `token_env` 726, `base64_decode` 672, `net_server` 586*
