...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 249 | 52% |
| **C2** | Powerful (one of) | 181 | 38% |
| **C1** | Ordinary | 19 | 4% |
| **C0** | No notable surface | 31 | 6% |

**90% of top plugins carry a powerful capability surface (C2+); 52% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**334 plugins (70%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 88,581★
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) — 28,970★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,036★
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) — 12,105★
- [Q00/ouroboros](https://github.com/Q00/ouroboros) — 5,526★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**105 plugins (22%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-18 · 480 of 499 repositories scanned · Top flags: `runtime_patch` 334, `exec` 289, `base64_decode` 125, `token_env` 105, `net_server` 90, `prompt_surface` 74*
