...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 10211 | 83% |
| Declares only dsh.client — not installable | 638 | 5% |
| No dsh integration found | 494 | 4% |
| A skill, not an installable plugin | 388 | 3% |
| Depends on dsh packages, no plugin manifest | 382 | 3% |
| Plugin code with no manifest to install it by | 200 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4022 | 33% |
| **C2** | Powerful (one of) | 7191 | 58% |
| **C1** | Ordinary | 672 | 5% |
| **C0** | No notable surface | 428 | 3% |

**91% of scanned plugins carry a powerful capability surface (C2+); 33% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**10112 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,935★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 32,166★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,918★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,086★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,956★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1244 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-30 · 12313 of 12612 repositories scanned · Top flags: `runtime_patch` 10112, `exec` 3729, `prompt_surface` 1381, `token_env` 1244, `base64_decode` 997, `net_server` 870*
