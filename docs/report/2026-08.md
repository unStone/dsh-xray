...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 13277 | 85% |
| Declares only dsh.client — not installable | 669 | 4% |
| No dsh integration found | 548 | 4% |
| A skill, not an installable plugin | 452 | 3% |
| Depends on dsh packages, no plugin manifest | 452 | 3% |
| Plugin code with no manifest to install it by | 207 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4818 | 31% |
| **C2** | Powerful (one of) | 9570 | 61% |
| **C1** | Ordinary | 729 | 5% |
| **C0** | No notable surface | 488 | 3% |
...
<!--STATS_PATCH-->
**13156 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 98,013★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 71,349★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,408★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 29,826★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 28,923★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1527 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-25 · 15605 of 15937 repositories scanned · Top flags: `runtime_patch` 13156, `exec` 4337, `prompt_surface` 1859, `token_env` 1527, `base64_decode` 1362, `net_server` 1167*
