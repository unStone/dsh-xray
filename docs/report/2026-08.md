...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 1722 | 43% |
| **C2** | Powerful (one of) | 1875 | 47% |
| **C1** | Ordinary | 240 | 6% |
| **C0** | No notable surface | 135 | 3% |

**91% of top plugins carry a powerful capability surface (C2+); 43% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->

As the sample grew — 80, then 169, then 480 repositories — the C2+ share moved 80% → 85% → 90%. It did not regress toward a benign tail, which is what you would expect if the first sample had been unluckily severe. The shape is structural.
...
<!--STATS_PATCH-->
**3051 plugins (77%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) — 28,977★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,048★
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) — 12,105★
- [Q00/ouroboros](https://github.com/Q00/ouroboros) — 5,525★
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) — 4,360★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**425 plugins (11%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-18 · 3972 of 4092 repositories scanned · Top flags: `runtime_patch` 3051, `exec` 1744, `base64_decode` 572, `prompt_surface` 526, `token_env` 425, `net_server` 384*
