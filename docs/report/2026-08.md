...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11829 | 84% |
| Declares only dsh.client — not installable | 652 | 5% |
| No dsh integration found | 535 | 4% |
| Depends on dsh packages, no plugin manifest | 431 | 3% |
| A skill, not an installable plugin | 417 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4197 | 30% |
| **C2** | Powerful (one of) | 8681 | 62% |
| **C1** | Ordinary | 731 | 5% |
| **C0** | No notable surface | 455 | 3% |
...
<!--STATS_PATCH-->
**11721 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 95,667★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 58,827★
- [reactive-resume/app](https://github.com/reactive-resume/app) — 42,495★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 22,451★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,290★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1337 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-12 · 14064 of 14380 repositories scanned · Top flags: `runtime_patch` 11721, `exec` 3820, `prompt_surface` 1641, `token_env` 1337, `base64_decode` 1174, `net_server` 973*
