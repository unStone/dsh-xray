...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11190 | 84% |
| Declares only dsh.client — not installable | 637 | 5% |
| No dsh integration found | 522 | 4% |
| A skill, not an installable plugin | 413 | 3% |
| Depends on dsh packages, no plugin manifest | 396 | 3% |
| Plugin code with no manifest to install it by | 204 | 2% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3925 | 29% |
| **C2** | Powerful (one of) | 8278 | 62% |
| **C1** | Ordinary | 711 | 5% |
| **C0** | No notable surface | 448 | 3% |
...
<!--STATS_PATCH-->
**11087 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 94,331★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 49,793★
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 42,225★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 21,469★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,201★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1283 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-06 · 13362 of 13669 repositories scanned · Top flags: `runtime_patch` 11087, `exec` 3567, `prompt_surface` 1536, `token_env` 1283, `base64_decode` 1082, `exec_bundled` 910*
