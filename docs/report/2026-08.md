...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 11961 | 84% |
| Declares only dsh.client — not installable | 655 | 5% |
| No dsh integration found | 536 | 4% |
| Depends on dsh packages, no plugin manifest | 437 | 3% |
| A skill, not an installable plugin | 419 | 3% |
| Plugin code with no manifest to install it by | 203 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4264 | 30% |
| **C2** | Powerful (one of) | 8754 | 62% |
| **C1** | Ordinary | 737 | 5% |
| **C0** | No notable surface | 456 | 3% |
...
<!--STATS_PATCH-->
**11852 plugins (83%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 95,831★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 59,998★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 42,604★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 22,725★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,301★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1354 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-13 · 14211 of 14529 repositories scanned · Top flags: `runtime_patch` 11852, `exec` 3878, `prompt_surface` 1658, `token_env` 1354, `base64_decode` 1201, `net_server` 1002*
