...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 9939 | 83% |
| Declares only dsh.client — not installable | 628 | 5% |
| No dsh integration found | 486 | 4% |
| Depends on dsh packages, no plugin manifest | 381 | 3% |
| A skill, not an installable plugin | 377 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 3889 | 32% |
| **C2** | Powerful (one of) | 7034 | 59% |
| **C1** | Ordinary | 669 | 6% |
| **C0** | No notable surface | 419 | 3% |

**91% of scanned plugins carry a powerful capability surface (C2+); 32% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**9845 plugins (82%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,867★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 25,831★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 20,843★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,065★
- [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) — 6,923★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1202 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-28 · 12011 of 12305 repositories scanned · Top flags: `runtime_patch` 9845, `exec` 3590, `prompt_surface` 1336, `token_env` 1202, `base64_decode` 964, `net_server` 824*
