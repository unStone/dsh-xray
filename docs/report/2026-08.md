...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 7692 | 81% |
| Declares only dsh.client — not installable | 546 | 6% |
| No dsh integration found | 434 | 5% |
| A skill, not an installable plugin | 327 | 3% |
| Depends on dsh packages, no plugin manifest | 312 | 3% |
| Plugin code with no manifest to install it by | 165 | 2% |

**19% of repositories carrying the `dsh-plugin` topic are not installable plugins.**
<!--/STATS_TYPES-->
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 2773 | 29% |
| **C2** | Powerful (one of) | 5758 | 61% |
| **C1** | Ordinary | 588 | 6% |
| **C0** | No notable surface | 357 | 4% |

**90% of scanned plugins carry a powerful capability surface (C2+); 29% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**7624 plugins (80%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) — 41,359★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 14,779★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 10,856★
- [Q00/ouroboros](https://github.com/Q00/ouroboros) — 5,596★
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) — 5,218★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**778 plugins (8%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-08-21 · 9476 of 9736 repositories scanned · Top flags: `runtime_patch` 7624, `exec` 2733, `prompt_surface` 1013, `token_env` 778, `base64_decode` 729, `net_server` 632*
