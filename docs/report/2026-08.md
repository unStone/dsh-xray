...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 13126 | 85% |
| Declares only dsh.client — not installable | 659 | 4% |
| No dsh integration found | 546 | 4% |
| Depends on dsh packages, no plugin manifest | 452 | 3% |
| A skill, not an installable plugin | 449 | 3% |
| Plugin code with no manifest to install it by | 206 | 1% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4759 | 31% |
| **C2** | Powerful (one of) | 9473 | 61% |
| **C1** | Ordinary | 729 | 5% |
| **C0** | No notable surface | 477 | 3% |
...
<!--STATS_PATCH-->
**13008 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 97,709★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 70,167★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,349★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 29,136★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 28,605★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1500 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-23 · 15438 of 15773 repositories scanned · Top flags: `runtime_patch` 13008, `exec` 4301, `prompt_surface` 1839, `token_env` 1500, `base64_decode` 1349, `net_server` 1148*
