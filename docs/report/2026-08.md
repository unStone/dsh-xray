...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12308 | 85% |
| Declares only dsh.client — not installable | 655 | 4% |
| No dsh integration found | 533 | 4% |
| Depends on dsh packages, no plugin manifest | 439 | 3% |
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4424 | 30% |
| **C2** | Powerful (one of) | 8946 | 61% |
| **C1** | Ordinary | 736 | 5% |
| **C0** | No notable surface | 458 | 3% |
...
<!--STATS_PATCH-->
**12197 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 96,434★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 64,030★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,005★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 24,623★
- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) — 11,366★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1407 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-16 · 14564 of 14891 repositories scanned · Top flags: `runtime_patch` 12197, `exec` 4011, `prompt_surface` 1693, `token_env` 1407, `base64_decode` 1252, `net_server` 1044*
