...
| Kind | Count | Share |
|---|---|---|
| Installable plugin (declares dsh.bundle) | 12977 | 85% |
| Declares only dsh.client — not installable | 652 | 4% |
| No dsh integration found | 546 | 4% |
| Depends on dsh packages, no plugin manifest | 451 | 3% |
| A skill, not an installable plugin | 443 | 3% |
| Plugin code with no manifest to install it by | 205 | 1% |

**15% of repositories carrying the `dsh-plugin` topic are not installable plugins.**
<!--/STATS_TYPES-->
...
|---|---|---|---|
| **C3** | Powerful + sensitive behavior | 4710 | 31% |
| **C2** | Powerful (one of) | 9362 | 61% |
| **C1** | Ordinary | 728 | 5% |
| **C0** | No notable surface | 474 | 3% |

**92% of scanned plugins carry a powerful capability surface (C2+); 31% combine it with sensitive behavior (C3).**
<!--/STATS_LEVELS-->
...
<!--STATS_PATCH-->
**12859 plugins (84%) patch the dsh runtime itself via `manifest.bundle.patch`.**

The most-starred among them:

- [nexu-io/open-design](https://github.com/nexu-io/open-design) — 97,530★
- [tt-a1i/archify](https://github.com/tt-a1i/archify) — 69,370★
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) — 43,295★
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) — 28,678★
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) — 28,381★
<!--/STATS_PATCH-->
...
<!--STATS_TOKEN-->
**1474 plugins (10%) read credential-class environment variables** (names containing KEY/TOKEN/SECRET/PASSWORD), spanning AWS, Aliyun OSS, GitHub, and several model-provider APIs.
<!--/STATS_TOKEN-->
...
<!--FOOTER-->
*Data snapshot: 2026-09-22 · 15274 of 15612 repositories scanned · Top flags: `runtime_patch` 12859, `exec` 4267, `prompt_surface` 1803, `token_env` 1474, `base64_decode` 1341, `net_server` 1130*
